...
func (a *FactionWarfareApiService) GetFwLeaderboards(localVarOptionals map[string]interface{}) (GetFwLeaderboardsOk, *http.Response, error) {
	var (
...
func (a *FactionWarfareApiService) GetFwLeaderboardsCharacters(localVarOptionals map[string]interface{}) (GetFwLeaderboardsCharactersOk, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *FactionWarfareApiService) GetFwLeaderboardsCorporations(localVarOptionals map[string]interface{}) (GetFwLeaderboardsCorporationsOk, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *FactionWarfareApiService) GetFwStats(localVarOptionals map[string]interface{}) ([]GetFwStats200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *FactionWarfareApiService) GetFwSystems(localVarOptionals map[string]interface{}) ([]GetFwSystems200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *FactionWarfareApiService) GetFwWars(localVarOptionals map[string]interface{}) ([]GetFwWars200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
