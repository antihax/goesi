...
func easyjson12937ed3DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdStatsCharacterList) {
...
func easyjson12937ed3EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdStatsCharacterList) {
...
func (v GetCharactersCharacterIdStatsCharacterList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson12937ed3EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdStatsCharacterList) UnmarshalJSON(data []byte) error {
	...
	easyjson12937ed3DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdStatsCharacterList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson12937ed3DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson12937ed3DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdStatsCharacter) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson12937ed3EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdStatsCharacter) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCharactersCharacterIdStatsCharacter) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson12937ed3EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdStatsCharacter) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson12937ed3DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdStatsCharacter) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson12937ed3DecodeGithubComAntihaxGoesiEsi1(l, v)
}
