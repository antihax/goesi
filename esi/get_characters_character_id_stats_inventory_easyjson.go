...
func easyjsonE3fb50eDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdStatsInventoryList) {
...
func easyjsonE3fb50eEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdStatsInventoryList) {
...
func (v GetCharactersCharacterIdStatsInventoryList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE3fb50eEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdStatsInventoryList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE3fb50eDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdStatsInventoryList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE3fb50eDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonE3fb50eDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdStatsInventory) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE3fb50eEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdStatsInventory) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCharactersCharacterIdStatsInventory) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE3fb50eEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdStatsInventory) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE3fb50eDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdStatsInventory) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE3fb50eDecodeGithubComAntihaxGoesiEsi1(l, v)
}
