...
func easyjson8204a652DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdOrdersHistory200OkList) {
...
func easyjson8204a652EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdOrdersHistory200OkList) {
...
func (v GetCorporationsCorporationIdOrdersHistory200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8204a652EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdOrdersHistory200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson8204a652DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOrdersHistory200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8204a652DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson8204a652DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdOrdersHistory200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8204a652EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdOrdersHistory200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.OrderId != 0 {
...
func (v GetCorporationsCorporationIdOrdersHistory200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8204a652EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdOrdersHistory200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8204a652DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOrdersHistory200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8204a652DecodeGithubComAntihaxGoesiEsi1(l, v)
}
