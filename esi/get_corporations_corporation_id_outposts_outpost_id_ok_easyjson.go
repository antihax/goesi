...
func easyjson5b857651DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdOutpostsOutpostIdOk) {
	...
	for !in.IsDelim('}') {
		...
		case "coordinates":
			easyjson5b857651DecodeGithubComAntihaxGoesiEsi2(in, &out.Coordinates)
		case "services":
			if in.IsNull() {
				in.Skip()
				out.Services = nil
				...
				for !in.IsDelim(']') {
					...
					easyjson5b857651DecodeGithubComAntihaxGoesiEsi3(in, &v4)
...
func easyjson5b857651EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdOutpostsOutpostIdOk) {
	...
	if true {
		...
		easyjson5b857651EncodeGithubComAntihaxGoesiEsi2(out, in.Coordinates)
	}
	if len(in.Services) != 0 {
		...
		}
		{
			...
			for v5, v6 := range in.Services {
				...
				easyjson5b857651EncodeGithubComAntihaxGoesiEsi3(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjson5b857651DecodeGithubComAntihaxGoesiEsi3(in *jlexer.Lexer, out *GetCorporationsCorporationIdOutpostsOutpostIdService) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5b857651EncodeGithubComAntihaxGoesiEsi3(out *jwriter.Writer, in GetCorporationsCorporationIdOutpostsOutpostIdService) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ServiceName != "" {
...
func easyjson5b857651DecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetCorporationsCorporationIdOutpostsOutpostIdCoordinates) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5b857651EncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetCorporationsCorporationIdOutpostsOutpostIdCoordinates) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
