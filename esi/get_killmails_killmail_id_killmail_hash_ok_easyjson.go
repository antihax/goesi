...
func easyjsonB5ebbfcbDecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashVictim) {
	...
	for !in.IsDelim('}') {
		...
		case "position":
			easyjsonB5ebbfcbDecodeGithubComAntihaxGoesiEsi3(in, &out.Position)
		case "ship_type_id":
...
func easyjsonB5ebbfcbEncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashVictim) {
	...
	if true {
		...
		easyjsonB5ebbfcbEncodeGithubComAntihaxGoesiEsi3(out, in.Position)
	}
	if in.ShipTypeId != 0 {
		if !first {
			out.RawByte(',')
...
func easyjsonB5ebbfcbDecodeGithubComAntihaxGoesiEsi3(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB5ebbfcbEncodeGithubComAntihaxGoesiEsi3(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
