...
func easyjson5d5f57a8DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) {
...
func easyjson5d5f57a8EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5d5f57a8EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson5d5f57a8DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5d5f57a8DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson5d5f57a8DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5d5f57a8EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5d5f57a8EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5d5f57a8DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5d5f57a8DecodeGithubComAntihaxGoesiEsi1(l, v)
}
