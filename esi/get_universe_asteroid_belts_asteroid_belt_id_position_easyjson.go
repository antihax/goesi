...
func easyjson313774f5DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) {
...
func easyjson313774f5EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson313774f5EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson313774f5DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson313774f5DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson313774f5DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetUniverseAsteroidBeltsAsteroidBeltIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson313774f5EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetUniverseAsteroidBeltsAsteroidBeltIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseAsteroidBeltsAsteroidBeltIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson313774f5EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson313774f5DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseAsteroidBeltsAsteroidBeltIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson313774f5DecodeGithubComAntihaxGoesiEsi1(l, v)
}
