...
func easyjsonE06267a0DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetUniverseMoonsMoonIdOk) {
	...
	for !in.IsDelim('}') {
		...
		case "position":
			easyjsonE06267a0DecodeGithubComAntihaxGoesiEsi2(in, &out.Position)
		case "system_id":
...
func easyjsonE06267a0EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetUniverseMoonsMoonIdOk) {
	...
	if true {
		...
		easyjsonE06267a0EncodeGithubComAntihaxGoesiEsi2(out, in.Position)
	}
	if in.SystemId != 0 {
		if !first {
			out.RawByte(',')
...
func easyjsonE06267a0DecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetUniverseMoonsMoonIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE06267a0EncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetUniverseMoonsMoonIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
