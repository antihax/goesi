...
func easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannels200OkList) {
...
func easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdChatChannels200OkList) {
...
func (v GetCharactersCharacterIdChatChannels200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdChatChannels200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannels200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannels200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "allowed":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi2(in, &v4)
		...
		case "operators":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi3(in, &v5)
		...
		case "blocked":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi4(in, &v6)
...
func easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannels200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ChannelId != 0 {
	...
	if len(in.Allowed) != 0 {
		...
		}
		{
			...
			for v8, v9 := range in.Allowed {
				...
				easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi2(out, v9)
			}
			out.RawByte(']')
		}
	}
	if len(in.Operators) != 0 {
		...
		}
		{
			...
			for v10, v11 := range in.Operators {
				...
				easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi3(out, v11)
			}
			out.RawByte(']')
		}
	}
	if len(in.Blocked) != 0 {
		...
		}
		{
			...
			for v12, v13 := range in.Blocked {
				...
				easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi4(out, v13)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdChatChannels200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannels200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannels200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi1(l, v)
}
func easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi4(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsBlocked) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi4(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsBlocked) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi3(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsOperator) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi3(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsOperator) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func easyjsonEbfd8375DecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsAllowed) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEbfd8375EncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsAllowed) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
