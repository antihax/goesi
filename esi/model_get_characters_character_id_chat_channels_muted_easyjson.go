...
func easyjsonBac7d225DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsMutedList) {
...
func easyjsonBac7d225EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsMutedList) {
...
func (v GetCharactersCharacterIdChatChannelsMutedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBac7d225EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdChatChannelsMutedList) UnmarshalJSON(data []byte) error {
	...
	easyjsonBac7d225DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsMutedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBac7d225DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonBac7d225DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsMuted) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBac7d225EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsMuted) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func (v GetCharactersCharacterIdChatChannelsMuted) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBac7d225EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannelsMuted) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonBac7d225DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsMuted) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBac7d225DecodeGithubComAntihaxGoesiEsi1(l, v)
}
