...
func easyjsonEdf64c32DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsOperatorList) {
...
func easyjsonEdf64c32EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsOperatorList) {
...
func (v GetCharactersCharacterIdChatChannelsOperatorList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEdf64c32EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdChatChannelsOperatorList) UnmarshalJSON(data []byte) error {
	...
	easyjsonEdf64c32DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsOperatorList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEdf64c32DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonEdf64c32DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsOperator) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEdf64c32EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsOperator) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func (v GetCharactersCharacterIdChatChannelsOperator) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEdf64c32EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannelsOperator) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEdf64c32DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsOperator) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEdf64c32DecodeGithubComAntihaxGoesiEsi1(l, v)
}
