...
func easyjson8f9350bfDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersCharacterIdWalletJournalExtraInfoList) {
...
func easyjson8f9350bfEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersCharacterIdWalletJournalExtraInfoList) {
...
func (v GetCharactersCharacterIdWalletJournalExtraInfoList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8f9350bfEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersCharacterIdWalletJournalExtraInfoList) UnmarshalJSON(data []byte) error {
	...
	easyjson8f9350bfDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdWalletJournalExtraInfoList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8f9350bfDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson8f9350bfDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersCharacterIdWalletJournalExtraInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8f9350bfEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersCharacterIdWalletJournalExtraInfo) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LocationId != 0 {
...
func (v GetCharactersCharacterIdWalletJournalExtraInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8f9350bfEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdWalletJournalExtraInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8f9350bfDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdWalletJournalExtraInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8f9350bfDecodeGithubComAntihaxGoesiEsi1(l, v)
}
