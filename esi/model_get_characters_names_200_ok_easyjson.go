...
func easyjson864fd50eDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCharactersNames200OkList) {
...
func easyjson864fd50eEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCharactersNames200OkList) {
...
func (v GetCharactersNames200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson864fd50eEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCharactersNames200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson864fd50eDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersNames200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson864fd50eDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson864fd50eDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCharactersNames200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson864fd50eEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCharactersNames200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func (v GetCharactersNames200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson864fd50eEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersNames200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson864fd50eDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersNames200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson864fd50eDecodeGithubComAntihaxGoesiEsi1(l, v)
}
