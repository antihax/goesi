...
func easyjson79e217a2DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdDivisionsHangarList) {
...
func easyjson79e217a2EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdDivisionsHangarList) {
...
func (v GetCorporationsCorporationIdDivisionsHangarList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson79e217a2EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdDivisionsHangarList) UnmarshalJSON(data []byte) error {
	...
	easyjson79e217a2DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdDivisionsHangarList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson79e217a2DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson79e217a2DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdDivisionsHangar) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson79e217a2EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdDivisionsHangar) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Division != 0 {
...
func (v GetCorporationsCorporationIdDivisionsHangar) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson79e217a2EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdDivisionsHangar) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson79e217a2DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdDivisionsHangar) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson79e217a2DecodeGithubComAntihaxGoesiEsi1(l, v)
}
