...
func easyjson467f7920DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCorporationsCorporationIdWalletsDivisionJournalExtraInfoList) {
...
func easyjson467f7920EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCorporationsCorporationIdWalletsDivisionJournalExtraInfoList) {
...
func (v GetCorporationsCorporationIdWalletsDivisionJournalExtraInfoList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson467f7920EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCorporationsCorporationIdWalletsDivisionJournalExtraInfoList) UnmarshalJSON(data []byte) error {
	...
	easyjson467f7920DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdWalletsDivisionJournalExtraInfoList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson467f7920DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson467f7920DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson467f7920EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo) {
	out.RawByte('{')
	first := true
	_ = first
	if in.LocationId != 0 {
...
func (v GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson467f7920EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson467f7920DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson467f7920DecodeGithubComAntihaxGoesiEsi1(l, v)
}
