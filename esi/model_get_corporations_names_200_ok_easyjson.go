...
func easyjsonB294c4edDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetCorporationsNames200OkList) {
...
func easyjsonB294c4edEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetCorporationsNames200OkList) {
...
func (v GetCorporationsNames200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB294c4edEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetCorporationsNames200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB294c4edDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsNames200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB294c4edDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonB294c4edDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetCorporationsNames200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB294c4edEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetCorporationsNames200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCorporationsNames200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB294c4edEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsNames200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB294c4edDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsNames200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB294c4edDecodeGithubComAntihaxGoesiEsi1(l, v)
}
