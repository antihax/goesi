...
func easyjsonB8627d23DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotalList) {
...
func easyjsonB8627d23EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsActiveTotalList) {
...
func (v GetFwLeaderboardsActiveTotalList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB8627d23EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsActiveTotalList) UnmarshalJSON(data []byte) error {
	...
	easyjsonB8627d23DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotalList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB8627d23DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonB8627d23DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsActiveTotal) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB8627d23EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsActiveTotal) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsActiveTotal) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB8627d23EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsActiveTotal) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonB8627d23DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsActiveTotal) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB8627d23DecodeGithubComAntihaxGoesiEsi1(l, v)
}
