...
func easyjson16bf495aDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersActiveTotalList) {
...
func easyjson16bf495aEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersActiveTotalList) {
...
func (v GetFwLeaderboardsCharactersActiveTotalList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson16bf495aEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersActiveTotalList) UnmarshalJSON(data []byte) error {
	...
	easyjson16bf495aDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersActiveTotalList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson16bf495aDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson16bf495aDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersActiveTotal) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson16bf495aEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersActiveTotal) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersActiveTotal) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson16bf495aEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersActiveTotal) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson16bf495aDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersActiveTotal) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson16bf495aDecodeGithubComAntihaxGoesiEsi1(l, v)
}
