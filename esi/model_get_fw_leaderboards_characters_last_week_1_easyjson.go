...
func easyjsonE016e3d8DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersLastWeek1List) {
...
func easyjsonE016e3d8EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersLastWeek1List) {
...
func (v GetFwLeaderboardsCharactersLastWeek1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE016e3d8EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersLastWeek1List) UnmarshalJSON(data []byte) error {
	...
	easyjsonE016e3d8DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersLastWeek1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE016e3d8DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonE016e3d8DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersLastWeek1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE016e3d8EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersLastWeek1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersLastWeek1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE016e3d8EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersLastWeek1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE016e3d8DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersLastWeek1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE016e3d8DecodeGithubComAntihaxGoesiEsi1(l, v)
}
