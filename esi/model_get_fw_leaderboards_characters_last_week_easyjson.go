...
func easyjson81491b7cDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersLastWeekList) {
...
func easyjson81491b7cEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersLastWeekList) {
...
func (v GetFwLeaderboardsCharactersLastWeekList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson81491b7cEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersLastWeekList) UnmarshalJSON(data []byte) error {
	...
	easyjson81491b7cDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersLastWeekList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson81491b7cDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson81491b7cDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersLastWeek) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson81491b7cEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersLastWeek) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersLastWeek) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson81491b7cEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersLastWeek) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson81491b7cDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersLastWeek) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson81491b7cDecodeGithubComAntihaxGoesiEsi1(l, v)
}
