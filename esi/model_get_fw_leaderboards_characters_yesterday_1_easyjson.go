...
func easyjson935f235bDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersYesterday1List) {
...
func easyjson935f235bEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCharactersYesterday1List) {
...
func (v GetFwLeaderboardsCharactersYesterday1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson935f235bEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCharactersYesterday1List) UnmarshalJSON(data []byte) error {
	...
	easyjson935f235bDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersYesterday1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson935f235bDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson935f235bDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCharactersYesterday1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson935f235bEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCharactersYesterday1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCharactersYesterday1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson935f235bEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCharactersYesterday1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson935f235bDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCharactersYesterday1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson935f235bDecodeGithubComAntihaxGoesiEsi1(l, v)
}
