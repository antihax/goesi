...
func easyjson3c31a465DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsLastWeek1List) {
...
func easyjson3c31a465EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsLastWeek1List) {
...
func (v GetFwLeaderboardsCorporationsLastWeek1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c31a465EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsLastWeek1List) UnmarshalJSON(data []byte) error {
	...
	easyjson3c31a465DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsLastWeek1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c31a465DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson3c31a465DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsLastWeek1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c31a465EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsLastWeek1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsLastWeek1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c31a465EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsLastWeek1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3c31a465DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsLastWeek1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c31a465DecodeGithubComAntihaxGoesiEsi1(l, v)
}
