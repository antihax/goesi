...
func easyjson67de4741DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsLastWeekList) {
...
func easyjson67de4741EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsLastWeekList) {
...
func (v GetFwLeaderboardsCorporationsLastWeekList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson67de4741EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsLastWeekList) UnmarshalJSON(data []byte) error {
	...
	easyjson67de4741DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsLastWeekList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson67de4741DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson67de4741DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsLastWeek) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson67de4741EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsLastWeek) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsLastWeek) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson67de4741EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsLastWeek) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson67de4741DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsLastWeek) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson67de4741DecodeGithubComAntihaxGoesiEsi1(l, v)
}
