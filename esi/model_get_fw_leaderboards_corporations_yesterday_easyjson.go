...
func easyjson70bc7822DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsYesterdayList) {
...
func easyjson70bc7822EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsCorporationsYesterdayList) {
...
func (v GetFwLeaderboardsCorporationsYesterdayList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson70bc7822EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsCorporationsYesterdayList) UnmarshalJSON(data []byte) error {
	...
	easyjson70bc7822DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsYesterdayList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson70bc7822DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson70bc7822DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsCorporationsYesterday) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson70bc7822EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsCorporationsYesterday) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsCorporationsYesterday) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson70bc7822EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsCorporationsYesterday) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson70bc7822DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsCorporationsYesterday) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson70bc7822DecodeGithubComAntihaxGoesiEsi1(l, v)
}
