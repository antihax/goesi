...
func easyjson1fd76ee7DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsLastWeekList) {
...
func easyjson1fd76ee7EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsLastWeekList) {
...
func (v GetFwLeaderboardsLastWeekList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1fd76ee7EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsLastWeekList) UnmarshalJSON(data []byte) error {
	...
	easyjson1fd76ee7DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsLastWeekList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1fd76ee7DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson1fd76ee7DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsLastWeek) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1fd76ee7EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsLastWeek) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsLastWeek) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1fd76ee7EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsLastWeek) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1fd76ee7DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsLastWeek) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1fd76ee7DecodeGithubComAntihaxGoesiEsi1(l, v)
}
