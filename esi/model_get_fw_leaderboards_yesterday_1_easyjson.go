...
func easyjsonE5d84d1cDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsYesterday1List) {
...
func easyjsonE5d84d1cEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsYesterday1List) {
...
func (v GetFwLeaderboardsYesterday1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE5d84d1cEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsYesterday1List) UnmarshalJSON(data []byte) error {
	...
	easyjsonE5d84d1cDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterday1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE5d84d1cDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjsonE5d84d1cDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsYesterday1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE5d84d1cEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsYesterday1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsYesterday1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE5d84d1cEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsYesterday1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE5d84d1cDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterday1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE5d84d1cDecodeGithubComAntihaxGoesiEsi1(l, v)
}
