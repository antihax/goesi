...
func easyjson1d2e18f8DecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetFwLeaderboardsYesterdayList) {
...
func easyjson1d2e18f8EncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetFwLeaderboardsYesterdayList) {
...
func (v GetFwLeaderboardsYesterdayList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1d2e18f8EncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetFwLeaderboardsYesterdayList) UnmarshalJSON(data []byte) error {
	...
	easyjson1d2e18f8DecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterdayList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1d2e18f8DecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson1d2e18f8DecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetFwLeaderboardsYesterday) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1d2e18f8EncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetFwLeaderboardsYesterday) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetFwLeaderboardsYesterday) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1d2e18f8EncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetFwLeaderboardsYesterday) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1d2e18f8DecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetFwLeaderboardsYesterday) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1d2e18f8DecodeGithubComAntihaxGoesiEsi1(l, v)
}
