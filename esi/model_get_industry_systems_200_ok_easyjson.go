		...
		case "cost_indices":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonA4a1cff6DecodeGithubComAntihaxGoesiEsi2(in, &v4)
	...
	if len(in.CostIndices) != 0 {
		...
		out.RawString(prefix[1:])
		{
			...
			for v5, v6 := range in.CostIndices {
				...
				easyjsonA4a1cff6EncodeGithubComAntihaxGoesiEsi2(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonA4a1cff6DecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetIndustrySystemsCostIndice) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA4a1cff6EncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetIndustrySystemsCostIndice) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Activity != "" {
