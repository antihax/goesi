...
func easyjson86fe613aDecodeGithubComAntihaxGoesiEsi(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem1List) {
...
func easyjson86fe613aEncodeGithubComAntihaxGoesiEsi(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem1List) {
...
func (v GetKillmailsKillmailIdKillmailHashItem1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson86fe613aEncodeGithubComAntihaxGoesiEsi(&w, v)
...
func (v *GetKillmailsKillmailIdKillmailHashItem1List) UnmarshalJSON(data []byte) error {
	...
	easyjson86fe613aDecodeGithubComAntihaxGoesiEsi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItem1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson86fe613aDecodeGithubComAntihaxGoesiEsi(l, v)
}
func easyjson86fe613aDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "items":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson86fe613aDecodeGithubComAntihaxGoesiEsi2(in, &v4)
...
func easyjson86fe613aEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
...
func (v GetKillmailsKillmailIdKillmailHashItem1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson86fe613aEncodeGithubComAntihaxGoesiEsi1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetKillmailsKillmailIdKillmailHashItem1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson86fe613aDecodeGithubComAntihaxGoesiEsi1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItem1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson86fe613aDecodeGithubComAntihaxGoesiEsi1(l, v)
}
func easyjson86fe613aDecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson86fe613aEncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
