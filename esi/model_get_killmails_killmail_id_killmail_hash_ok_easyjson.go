		...
		case "attackers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson79bc02b5DecodeGithubComAntihaxGoesiEsi3(in, &v4)
	...
	if len(in.Attackers) != 0 {
		...
		}
		{
			...
			for v5, v6 := range in.Attackers {
				...
				easyjson79bc02b5EncodeGithubComAntihaxGoesiEsi3(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjson79bc02b5DecodeGithubComAntihaxGoesiEsi3(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashAttacker) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson79bc02b5EncodeGithubComAntihaxGoesiEsi3(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashAttacker) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
...
func easyjson79bc02b5DecodeGithubComAntihaxGoesiEsi2(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashVictim) {
	...
	for !in.IsDelim('}') {
		...
		case "position":
			easyjson79bc02b5DecodeGithubComAntihaxGoesiEsi4(in, &out.Position)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson79bc02b5EncodeGithubComAntihaxGoesiEsi2(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashVictim) {
	...
	if true {
		...
		easyjson79bc02b5EncodeGithubComAntihaxGoesiEsi4(out, in.Position)
	}
	out.RawByte('}')
}
func easyjson79bc02b5DecodeGithubComAntihaxGoesiEsi4(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson79bc02b5EncodeGithubComAntihaxGoesiEsi4(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
