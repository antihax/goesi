...
func easyjsonF6dfc9daDecodeGithubComAntihaxGoesiEsi1(in *jlexer.Lexer, out *GetWarsWarIdOk) {
	...
	for !in.IsDelim('}') {
		...
		case "defender":
			easyjsonF6dfc9daDecodeGithubComAntihaxGoesiEsi3(in, &out.Defender)
		case "allies":
			if in.IsNull() {
				in.Skip()
				out.Allies = nil
				...
				for !in.IsDelim(']') {
					...
					easyjsonF6dfc9daDecodeGithubComAntihaxGoesiEsi4(in, &v4)
...
func easyjsonF6dfc9daEncodeGithubComAntihaxGoesiEsi1(out *jwriter.Writer, in GetWarsWarIdOk) {
	...
	if true {
		...
		easyjsonF6dfc9daEncodeGithubComAntihaxGoesiEsi3(out, in.Defender)
	}
	if len(in.Allies) != 0 {
		...
		}
		{
			...
			for v5, v6 := range in.Allies {
				...
				easyjsonF6dfc9daEncodeGithubComAntihaxGoesiEsi4(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonF6dfc9daDecodeGithubComAntihaxGoesiEsi4(in *jlexer.Lexer, out *GetWarsWarIdAlly) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF6dfc9daEncodeGithubComAntihaxGoesiEsi4(out *jwriter.Writer, in GetWarsWarIdAlly) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjsonF6dfc9daDecodeGithubComAntihaxGoesiEsi3(in *jlexer.Lexer, out *GetWarsWarIdDefender) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF6dfc9daEncodeGithubComAntihaxGoesiEsi3(out *jwriter.Writer, in GetWarsWarIdDefender) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CorporationId != 0 {
