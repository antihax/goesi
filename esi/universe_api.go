...
func (a *UniverseApiService) GetUniverseFactions(localVarOptionals map[string]interface{}) ([]GetUniverseFactions200Ok, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.basePath + "/v1/universe/factions/"
...
func (a *UniverseApiService) GetUniverseStarsStarId(starId int32, localVarOptionals map[string]interface{}) (GetUniverseStarsStarIdOk, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *UniverseApiService) GetUniverseSystemJumps(localVarOptionals map[string]interface{}) ([]GetUniverseSystemJumps200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *UniverseApiService) GetUniverseSystemKills(localVarOptionals map[string]interface{}) ([]GetUniverseSystemKills200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
