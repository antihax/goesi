...
@return */
func (a *FittingsApiService) DeleteCharactersCharacterIdFittingsFittingId(ctx context.Context, fittingId int32, characterId int32, localVarOptionals map[string]interface{}) (*http.Response, error) {
	var (
