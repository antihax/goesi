...
func easyjsonF74ffa65DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetAlliancesAllianceIdIconsOkList) {
...
func easyjsonF74ffa65EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetAlliancesAllianceIdIconsOkList) {
...
func (v GetAlliancesAllianceIdIconsOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF74ffa65EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetAlliancesAllianceIdIconsOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF74ffa65DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdIconsOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF74ffa65DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonF74ffa65DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetAlliancesAllianceIdIconsOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF74ffa65EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetAlliancesAllianceIdIconsOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Px128x128 != "" {
...
func (v GetAlliancesAllianceIdIconsOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF74ffa65EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetAlliancesAllianceIdIconsOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF74ffa65DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdIconsOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF74ffa65DecodeGithubComAntihaxGoesiV11(l, v)
}
