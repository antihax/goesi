...
func easyjson67f82948DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetAlliancesAllianceIdOkList) {
...
func easyjson67f82948EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetAlliancesAllianceIdOkList) {
...
func (v GetAlliancesAllianceIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson67f82948EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetAlliancesAllianceIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson67f82948DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson67f82948DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson67f82948DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetAlliancesAllianceIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson67f82948EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetAlliancesAllianceIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceName != "" {
	...
	if in.ExecutorCorporationId != 0 {
		...
		first = false
		out.RawString("\"executor_corporation_id\":")
...
func (v GetAlliancesAllianceIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson67f82948EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetAlliancesAllianceIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson67f82948DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesAllianceIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson67f82948DecodeGithubComAntihaxGoesiV11(l, v)
}
