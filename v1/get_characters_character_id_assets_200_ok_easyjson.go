...
func easyjsonDb968ffbDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdAssets200OkList) {
...
func easyjsonDb968ffbEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdAssets200OkList) {
...
func (v GetCharactersCharacterIdAssets200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDb968ffbEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdAssets200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonDb968ffbDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdAssets200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDb968ffbDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonDb968ffbDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdAssets200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDb968ffbEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdAssets200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IsSingleton {
...
func (v GetCharactersCharacterIdAssets200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDb968ffbEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdAssets200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonDb968ffbDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdAssets200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDb968ffbDecodeGithubComAntihaxGoesiV11(l, v)
}
