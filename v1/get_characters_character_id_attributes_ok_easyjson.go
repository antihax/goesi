...
func easyjson8920fc7eDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdAttributesOkList) {
...
func easyjson8920fc7eEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdAttributesOkList) {
...
func (v GetCharactersCharacterIdAttributesOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8920fc7eEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdAttributesOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson8920fc7eDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdAttributesOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8920fc7eDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson8920fc7eDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdAttributesOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8920fc7eEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdAttributesOk) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetCharactersCharacterIdAttributesOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8920fc7eEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdAttributesOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8920fc7eDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdAttributesOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8920fc7eDecodeGithubComAntihaxGoesiV11(l, v)
}
