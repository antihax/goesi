...
func easyjson887755aeDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdBlueprints200OkList) {
...
func easyjson887755aeEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdBlueprints200OkList) {
...
func (v GetCharactersCharacterIdBlueprints200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson887755aeEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdBlueprints200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson887755aeDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBlueprints200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson887755aeDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson887755aeDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdBlueprints200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson887755aeEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdBlueprints200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ItemId != 0 {
...
func (v GetCharactersCharacterIdBlueprints200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson887755aeEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdBlueprints200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson887755aeDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBlueprints200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson887755aeDecodeGithubComAntihaxGoesiV11(l, v)
}
