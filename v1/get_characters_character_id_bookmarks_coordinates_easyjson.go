...
func easyjson71e2adadDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdBookmarksCoordinatesList) {
...
func easyjson71e2adadEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdBookmarksCoordinatesList) {
...
func (v GetCharactersCharacterIdBookmarksCoordinatesList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson71e2adadEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdBookmarksCoordinatesList) UnmarshalJSON(data []byte) error {
	...
	easyjson71e2adadDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBookmarksCoordinatesList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson71e2adadDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson71e2adadDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdBookmarksCoordinates) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson71e2adadEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdBookmarksCoordinates) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetCharactersCharacterIdBookmarksCoordinates) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson71e2adadEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdBookmarksCoordinates) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson71e2adadDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBookmarksCoordinates) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson71e2adadDecodeGithubComAntihaxGoesiV11(l, v)
}
