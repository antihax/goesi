...
func easyjsonC6adb315DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdBookmarksTargetList) {
...
func easyjsonC6adb315EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdBookmarksTargetList) {
...
func (v GetCharactersCharacterIdBookmarksTargetList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC6adb315EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdBookmarksTargetList) UnmarshalJSON(data []byte) error {
	...
	easyjsonC6adb315DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBookmarksTargetList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC6adb315DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonC6adb315DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdBookmarksTarget) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC6adb315EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdBookmarksTarget) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetCharactersCharacterIdBookmarksTarget) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC6adb315EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdBookmarksTarget) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC6adb315DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdBookmarksTarget) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC6adb315DecodeGithubComAntihaxGoesiV11(l, v)
}
