...
func easyjsonD9f0de9eDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsAllowedList) {
...
func easyjsonD9f0de9eEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsAllowedList) {
...
func (v GetCharactersCharacterIdChatChannelsAllowedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD9f0de9eEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdChatChannelsAllowedList) UnmarshalJSON(data []byte) error {
	...
	easyjsonD9f0de9eDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsAllowedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD9f0de9eDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonD9f0de9eDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsAllowed) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD9f0de9eEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsAllowed) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func (v GetCharactersCharacterIdChatChannelsAllowed) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD9f0de9eEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannelsAllowed) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD9f0de9eDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsAllowed) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD9f0de9eDecodeGithubComAntihaxGoesiV11(l, v)
}
