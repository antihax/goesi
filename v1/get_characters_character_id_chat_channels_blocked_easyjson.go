...
func easyjson429021f6DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsBlockedList) {
...
func easyjson429021f6EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsBlockedList) {
...
func (v GetCharactersCharacterIdChatChannelsBlockedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson429021f6EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdChatChannelsBlockedList) UnmarshalJSON(data []byte) error {
	...
	easyjson429021f6DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsBlockedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson429021f6DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson429021f6DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsBlocked) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson429021f6EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsBlocked) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func (v GetCharactersCharacterIdChatChannelsBlocked) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson429021f6EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannelsBlocked) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson429021f6DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsBlocked) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson429021f6DecodeGithubComAntihaxGoesiV11(l, v)
}
