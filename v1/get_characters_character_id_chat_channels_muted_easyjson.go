...
func easyjson3458d403DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsMutedList) {
...
func easyjson3458d403EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsMutedList) {
...
func (v GetCharactersCharacterIdChatChannelsMutedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3458d403EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdChatChannelsMutedList) UnmarshalJSON(data []byte) error {
	...
	easyjson3458d403DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsMutedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3458d403DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson3458d403DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsMuted) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3458d403EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsMuted) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func (v GetCharactersCharacterIdChatChannelsMuted) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3458d403EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannelsMuted) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3458d403DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsMuted) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3458d403DecodeGithubComAntihaxGoesiV11(l, v)
}
