...
func easyjson8f950614DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsOperatorList) {
...
func easyjson8f950614EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsOperatorList) {
...
func (v GetCharactersCharacterIdChatChannelsOperatorList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8f950614EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdChatChannelsOperatorList) UnmarshalJSON(data []byte) error {
	...
	easyjson8f950614DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsOperatorList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8f950614DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson8f950614DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdChatChannelsOperator) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8f950614EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdChatChannelsOperator) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessorId != 0 {
...
func (v GetCharactersCharacterIdChatChannelsOperator) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8f950614EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdChatChannelsOperator) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8f950614DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdChatChannelsOperator) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8f950614DecodeGithubComAntihaxGoesiV11(l, v)
}
