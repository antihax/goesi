...
func easyjsonF56e5f30DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdFittingsItemList) {
...
func easyjsonF56e5f30EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdFittingsItemList) {
...
func (v GetCharactersCharacterIdFittingsItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF56e5f30EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdFittingsItemList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF56e5f30DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFittingsItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF56e5f30DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonF56e5f30DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdFittingsItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF56e5f30EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdFittingsItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
...
func (v GetCharactersCharacterIdFittingsItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF56e5f30EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdFittingsItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF56e5f30DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdFittingsItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF56e5f30DecodeGithubComAntihaxGoesiV11(l, v)
}
