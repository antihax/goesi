...
func easyjson81fd3f84DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdKillmailsRecent200OkList) {
...
func easyjson81fd3f84EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdKillmailsRecent200OkList) {
...
func (v GetCharactersCharacterIdKillmailsRecent200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson81fd3f84EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdKillmailsRecent200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson81fd3f84DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdKillmailsRecent200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson81fd3f84DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson81fd3f84DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdKillmailsRecent200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson81fd3f84EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdKillmailsRecent200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.KillmailHash != "" {
...
func (v GetCharactersCharacterIdKillmailsRecent200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson81fd3f84EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdKillmailsRecent200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson81fd3f84DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdKillmailsRecent200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson81fd3f84DecodeGithubComAntihaxGoesiV11(l, v)
}
