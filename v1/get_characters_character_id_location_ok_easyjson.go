...
func easyjsonD8fab60cDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdLocationOkList) {
...
func easyjsonD8fab60cEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdLocationOkList) {
...
func (v GetCharactersCharacterIdLocationOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD8fab60cEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdLocationOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonD8fab60cDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdLocationOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD8fab60cDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonD8fab60cDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdLocationOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD8fab60cEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdLocationOk) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCharactersCharacterIdLocationOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD8fab60cEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdLocationOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD8fab60cDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdLocationOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD8fab60cDecodeGithubComAntihaxGoesiV11(l, v)
}
