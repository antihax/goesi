...
func easyjson914ad4e5DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdMailRecipientList) {
...
func easyjson914ad4e5EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdMailRecipientList) {
...
func (v GetCharactersCharacterIdMailRecipientList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson914ad4e5EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdMailRecipientList) UnmarshalJSON(data []byte) error {
	...
	easyjson914ad4e5DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailRecipientList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson914ad4e5DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson914ad4e5DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdMailRecipient) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson914ad4e5EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdMailRecipient) {
	out.RawByte('{')
	first := true
	_ = first
	if in.RecipientId != 0 {
...
func (v GetCharactersCharacterIdMailRecipient) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson914ad4e5EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMailRecipient) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson914ad4e5DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMailRecipient) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson914ad4e5DecodeGithubComAntihaxGoesiV11(l, v)
}
