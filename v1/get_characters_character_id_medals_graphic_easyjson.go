...
func easyjsonC809f51dDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdMedalsGraphicList) {
...
func easyjsonC809f51dEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdMedalsGraphicList) {
...
func (v GetCharactersCharacterIdMedalsGraphicList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC809f51dEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdMedalsGraphicList) UnmarshalJSON(data []byte) error {
	...
	easyjsonC809f51dDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMedalsGraphicList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC809f51dDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonC809f51dDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdMedalsGraphic) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC809f51dEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdMedalsGraphic) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Color != 0 {
...
func (v GetCharactersCharacterIdMedalsGraphic) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC809f51dEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdMedalsGraphic) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC809f51dDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdMedalsGraphic) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC809f51dDecodeGithubComAntihaxGoesiV11(l, v)
}
