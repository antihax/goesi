...
func easyjson5f788c63DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanets200OkList) {
...
func easyjson5f788c63EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdPlanets200OkList) {
...
func (v GetCharactersCharacterIdPlanets200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5f788c63EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdPlanets200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5f788c63DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanets200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5f788c63DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson5f788c63DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanets200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5f788c63EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdPlanets200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetCharactersCharacterIdPlanets200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5f788c63EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdPlanets200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5f788c63DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanets200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5f788c63DecodeGithubComAntihaxGoesiV11(l, v)
}
