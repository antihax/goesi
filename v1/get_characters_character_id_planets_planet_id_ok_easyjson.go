...
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdOkList) {
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdOkList) {
...
func (v GetCharactersCharacterIdPlanetsPlanetIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2db8f1a3EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "pins":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson2db8f1a3DecodeGithubComAntihaxGoesiV12(in, &v5)
		...
		case "routes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson2db8f1a3DecodeGithubComAntihaxGoesiV13(in, &v6)
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Links) != 0 {
	...
	if len(in.Pins) != 0 {
		...
		if in.Pins == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v9, v10 := range in.Pins {
				...
				easyjson2db8f1a3EncodeGithubComAntihaxGoesiV12(out, v10)
			}
			out.RawByte(']')
		}
	}
	if len(in.Routes) != 0 {
		...
		if in.Routes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v11, v12 := range in.Routes {
				...
				easyjson2db8f1a3EncodeGithubComAntihaxGoesiV13(out, v12)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdPlanetsPlanetIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2db8f1a3EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV11(l, v)
}
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV13(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "waypoints":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v13 GetCharactersCharacterIdPlanetsPlanetIdWaypoint
					easyjson2db8f1a3DecodeGithubComAntihaxGoesiV14(in, &v13)
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV13(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.Waypoints) != 0 {
		...
		if in.Waypoints == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v14, v15 := range in.Waypoints {
				...
				easyjson2db8f1a3EncodeGithubComAntihaxGoesiV14(out, v15)
			}
			out.RawByte(']')
		}
	}
...
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV14(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdWaypoint) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV14(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdWaypoint) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Order != 0 {
...
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV12(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdPin) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV12(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdPin) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
