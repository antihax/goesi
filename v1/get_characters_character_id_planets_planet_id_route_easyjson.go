...
func easyjson5a671d6eDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdRouteList) {
...
func easyjson5a671d6eEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdRouteList) {
...
func (v GetCharactersCharacterIdPlanetsPlanetIdRouteList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a671d6eEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdRouteList) UnmarshalJSON(data []byte) error {
	...
	easyjson5a671d6eDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdRouteList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a671d6eDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson5a671d6eDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "waypoints":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson5a671d6eDecodeGithubComAntihaxGoesiV12(in, &v4)
...
func easyjson5a671d6eEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.Waypoints) != 0 {
		...
		if in.Waypoints == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.Waypoints {
				...
				easyjson5a671d6eEncodeGithubComAntihaxGoesiV12(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdPlanetsPlanetIdRoute) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a671d6eEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdRoute) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5a671d6eDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdRoute) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a671d6eDecodeGithubComAntihaxGoesiV11(l, v)
}
func easyjson5a671d6eDecodeGithubComAntihaxGoesiV12(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdWaypoint) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5a671d6eEncodeGithubComAntihaxGoesiV12(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdWaypoint) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Order != 0 {
