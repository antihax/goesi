...
func easyjson76ba4e56DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdWallets200OkList) {
...
func easyjson76ba4e56EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdWallets200OkList) {
...
func (v GetCharactersCharacterIdWallets200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson76ba4e56EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdWallets200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson76ba4e56DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdWallets200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson76ba4e56DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson76ba4e56DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdWallets200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson76ba4e56EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdWallets200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Balance != 0 {
...
func (v GetCharactersCharacterIdWallets200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson76ba4e56EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdWallets200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson76ba4e56DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdWallets200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson76ba4e56DecodeGithubComAntihaxGoesiV11(l, v)
}
