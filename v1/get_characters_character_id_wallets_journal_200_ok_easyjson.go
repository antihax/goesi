...
func easyjson5867b91eDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCharactersCharacterIdWalletsJournal200OkList) {
...
func easyjson5867b91eEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCharactersCharacterIdWalletsJournal200OkList) {
...
func (v GetCharactersCharacterIdWalletsJournal200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5867b91eEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCharactersCharacterIdWalletsJournal200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson5867b91eDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdWalletsJournal200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5867b91eDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson5867b91eDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCharactersCharacterIdWalletsJournal200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5867b91eEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCharactersCharacterIdWalletsJournal200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Amount != 0 {
...
func (v GetCharactersCharacterIdWalletsJournal200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5867b91eEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdWalletsJournal200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson5867b91eDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdWalletsJournal200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5867b91eDecodeGithubComAntihaxGoesiV11(l, v)
}
