...
func easyjson8c4dd9f7DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCorporationsCorporationIdRoles200OkList) {
...
func easyjson8c4dd9f7EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCorporationsCorporationIdRoles200OkList) {
...
func (v GetCorporationsCorporationIdRoles200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8c4dd9f7EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCorporationsCorporationIdRoles200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson8c4dd9f7DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdRoles200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8c4dd9f7DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson8c4dd9f7DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCorporationsCorporationIdRoles200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8c4dd9f7EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCorporationsCorporationIdRoles200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CharacterId != 0 {
	...
	if len(in.RolesAtHq) != 0 {
		...
		first = false
		out.RawString("\"roles_at_hq\":")
		if in.RolesAtHq == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
	...
	if len(in.RolesAtOther) != 0 {
		...
		first = false
		out.RawString("\"roles_at_other\":")
		if in.RolesAtOther == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
...
func (v GetCorporationsCorporationIdRoles200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8c4dd9f7EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdRoles200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8c4dd9f7DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdRoles200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8c4dd9f7DecodeGithubComAntihaxGoesiV11(l, v)
}
