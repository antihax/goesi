...
type GetCorporationsCorporationIdStructures200Ok struct {
	...
	/* Set of {Day, Hour} for this week's vulnerability windows, Monday is day 0 */
	CurrentVul string `json:"current_vul,omitempty"`

	/* Date on which the structure will run out of fuel */
	FuelExpires SwaggerDateType `json:"fuel_expires,omitempty"`

	/* Set of {Day, Hour} for next week's vulnerability windows, Monday is day 0 */
	NextVul string `json:"next_vul,omitempty"`
