...
func easyjsonF6d56f96DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructures200OkList) {
...
func easyjsonF6d56f96EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCorporationsCorporationIdStructures200OkList) {
...
func (v GetCorporationsCorporationIdStructures200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF6d56f96EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCorporationsCorporationIdStructures200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonF6d56f96DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStructures200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF6d56f96DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonF6d56f96DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructures200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "current_vul":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonF6d56f96DecodeGithubComAntihaxGoesiV12(in, &v4)
		...
		case "next_vul":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonF6d56f96DecodeGithubComAntihaxGoesiV13(in, &v5)
		...
		case "services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonF6d56f96DecodeGithubComAntihaxGoesiV14(in, &v6)
...
func easyjsonF6d56f96EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCorporationsCorporationIdStructures200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.CurrentVul) != 0 {
		...
		if in.CurrentVul == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v7, v8 := range in.CurrentVul {
				...
				easyjsonF6d56f96EncodeGithubComAntihaxGoesiV12(out, v8)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.NextVul) != 0 {
		...
		if in.NextVul == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v9, v10 := range in.NextVul {
				...
				easyjsonF6d56f96EncodeGithubComAntihaxGoesiV13(out, v10)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.Services) != 0 {
		...
		if in.Services == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v11, v12 := range in.Services {
				...
				easyjsonF6d56f96EncodeGithubComAntihaxGoesiV14(out, v12)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCorporationsCorporationIdStructures200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF6d56f96EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdStructures200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF6d56f96DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStructures200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF6d56f96DecodeGithubComAntihaxGoesiV11(l, v)
}
func easyjsonF6d56f96DecodeGithubComAntihaxGoesiV14(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructuresService) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF6d56f96EncodeGithubComAntihaxGoesiV14(out *jwriter.Writer, in GetCorporationsCorporationIdStructuresService) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
...
func easyjsonF6d56f96DecodeGithubComAntihaxGoesiV13(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructuresNextVul) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF6d56f96EncodeGithubComAntihaxGoesiV13(out *jwriter.Writer, in GetCorporationsCorporationIdStructuresNextVul) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Day != 0 {
...
func easyjsonF6d56f96DecodeGithubComAntihaxGoesiV12(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructuresCurrentVul) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF6d56f96EncodeGithubComAntihaxGoesiV12(out *jwriter.Writer, in GetCorporationsCorporationIdStructuresCurrentVul) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Day != 0 {
