...
func easyjsonD96c3a4eDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructuresNextVulList) {
...
func easyjsonD96c3a4eEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetCorporationsCorporationIdStructuresNextVulList) {
...
func (v GetCorporationsCorporationIdStructuresNextVulList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD96c3a4eEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetCorporationsCorporationIdStructuresNextVulList) UnmarshalJSON(data []byte) error {
	...
	easyjsonD96c3a4eDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStructuresNextVulList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD96c3a4eDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonD96c3a4eDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetCorporationsCorporationIdStructuresNextVul) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD96c3a4eEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetCorporationsCorporationIdStructuresNextVul) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Day != 0 {
...
func (v GetCorporationsCorporationIdStructuresNextVul) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD96c3a4eEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdStructuresNextVul) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD96c3a4eDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdStructuresNextVul) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD96c3a4eDecodeGithubComAntihaxGoesiV11(l, v)
}
