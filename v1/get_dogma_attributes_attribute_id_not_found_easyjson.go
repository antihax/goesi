...
func easyjsonE956a2abDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetDogmaAttributesAttributeIdNotFoundList) {
...
func easyjsonE956a2abEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetDogmaAttributesAttributeIdNotFoundList) {
...
func (v GetDogmaAttributesAttributeIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE956a2abEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetDogmaAttributesAttributeIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE956a2abDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaAttributesAttributeIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE956a2abDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonE956a2abDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetDogmaAttributesAttributeIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE956a2abEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetDogmaAttributesAttributeIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetDogmaAttributesAttributeIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE956a2abEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaAttributesAttributeIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE956a2abDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaAttributesAttributeIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE956a2abDecodeGithubComAntihaxGoesiV11(l, v)
}
