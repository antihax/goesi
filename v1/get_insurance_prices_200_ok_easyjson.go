...
func easyjsonA53f7cDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetInsurancePrices200OkList) {
...
func easyjsonA53f7cEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetInsurancePrices200OkList) {
...
func (v GetInsurancePrices200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA53f7cEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetInsurancePrices200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonA53f7cDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetInsurancePrices200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA53f7cDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonA53f7cDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetInsurancePrices200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "levels":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonA53f7cDecodeGithubComAntihaxGoesiV12(in, &v4)
...
func easyjsonA53f7cEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetInsurancePrices200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Levels) != 0 {
		...
		if in.Levels == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.Levels {
				...
				easyjsonA53f7cEncodeGithubComAntihaxGoesiV12(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetInsurancePrices200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA53f7cEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetInsurancePrices200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonA53f7cDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetInsurancePrices200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA53f7cDecodeGithubComAntihaxGoesiV11(l, v)
}
func easyjsonA53f7cDecodeGithubComAntihaxGoesiV12(in *jlexer.Lexer, out *GetInsurancePricesLevel) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA53f7cEncodeGithubComAntihaxGoesiV12(out *jwriter.Writer, in GetInsurancePricesLevel) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Cost != 0 {
