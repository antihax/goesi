...
func easyjsonD53872d4DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem1List) {
...
func easyjsonD53872d4EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem1List) {
...
func (v GetKillmailsKillmailIdKillmailHashItem1List) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD53872d4EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetKillmailsKillmailIdKillmailHashItem1List) UnmarshalJSON(data []byte) error {
	...
	easyjsonD53872d4DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItem1List) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD53872d4DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonD53872d4DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem1) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "items":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonD53872d4DecodeGithubComAntihaxGoesiV12(in, &v4)
...
func easyjsonD53872d4EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem1) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
	...
	if len(in.Items) != 0 {
		...
		if in.Items == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.Items {
				...
				easyjsonD53872d4EncodeGithubComAntihaxGoesiV12(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v GetKillmailsKillmailIdKillmailHashItem1) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD53872d4EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetKillmailsKillmailIdKillmailHashItem1) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD53872d4DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItem1) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD53872d4DecodeGithubComAntihaxGoesiV11(l, v)
}
func easyjsonD53872d4DecodeGithubComAntihaxGoesiV12(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD53872d4EncodeGithubComAntihaxGoesiV12(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
