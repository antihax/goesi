...
func easyjson8e5c6700DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItemList) {
...
func easyjson8e5c6700EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItemList) {
...
func (v GetKillmailsKillmailIdKillmailHashItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8e5c6700EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetKillmailsKillmailIdKillmailHashItemList) UnmarshalJSON(data []byte) error {
	...
	easyjson8e5c6700DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8e5c6700DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson8e5c6700DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetKillmailsKillmailIdKillmailHashItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e5c6700EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetKillmailsKillmailIdKillmailHashItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
...
func (v GetKillmailsKillmailIdKillmailHashItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8e5c6700EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetKillmailsKillmailIdKillmailHashItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8e5c6700DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetKillmailsKillmailIdKillmailHashItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8e5c6700DecodeGithubComAntihaxGoesiV11(l, v)
}
