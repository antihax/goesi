...
func easyjson2c2475fbDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetLoyaltyStoresCorporationIdOffersRequiredItemList) {
...
func easyjson2c2475fbEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetLoyaltyStoresCorporationIdOffersRequiredItemList) {
...
func (v GetLoyaltyStoresCorporationIdOffersRequiredItemList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2c2475fbEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetLoyaltyStoresCorporationIdOffersRequiredItemList) UnmarshalJSON(data []byte) error {
	...
	easyjson2c2475fbDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetLoyaltyStoresCorporationIdOffersRequiredItemList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2c2475fbDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson2c2475fbDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetLoyaltyStoresCorporationIdOffersRequiredItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2c2475fbEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetLoyaltyStoresCorporationIdOffersRequiredItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Quantity != 0 {
...
func (v GetLoyaltyStoresCorporationIdOffersRequiredItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2c2475fbEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetLoyaltyStoresCorporationIdOffersRequiredItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2c2475fbDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetLoyaltyStoresCorporationIdOffersRequiredItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2c2475fbDecodeGithubComAntihaxGoesiV11(l, v)
}
