...
func easyjson288d22fbDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetMarketsGroupsMarketGroupIdOkList) {
...
func easyjson288d22fbEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetMarketsGroupsMarketGroupIdOkList) {
...
func (v GetMarketsGroupsMarketGroupIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson288d22fbEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetMarketsGroupsMarketGroupIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson288d22fbDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsGroupsMarketGroupIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson288d22fbDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson288d22fbDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetMarketsGroupsMarketGroupIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson288d22fbEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetMarketsGroupsMarketGroupIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
...
func (v GetMarketsGroupsMarketGroupIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson288d22fbEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsGroupsMarketGroupIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson288d22fbDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsGroupsMarketGroupIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson288d22fbDecodeGithubComAntihaxGoesiV11(l, v)
}
