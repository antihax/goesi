...
func easyjson4404cda3DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetMarketsRegionIdHistoryUnprocessableEntityList) {
...
func easyjson4404cda3EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetMarketsRegionIdHistoryUnprocessableEntityList) {
...
func (v GetMarketsRegionIdHistoryUnprocessableEntityList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4404cda3EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetMarketsRegionIdHistoryUnprocessableEntityList) UnmarshalJSON(data []byte) error {
	...
	easyjson4404cda3DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdHistoryUnprocessableEntityList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4404cda3DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson4404cda3DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetMarketsRegionIdHistoryUnprocessableEntity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4404cda3EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetMarketsRegionIdHistoryUnprocessableEntity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetMarketsRegionIdHistoryUnprocessableEntity) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4404cda3EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetMarketsRegionIdHistoryUnprocessableEntity) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4404cda3DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetMarketsRegionIdHistoryUnprocessableEntity) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4404cda3DecodeGithubComAntihaxGoesiV11(l, v)
}
