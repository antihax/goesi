...
func easyjsonFed925a0DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetOpportunitiesGroupsGroupIdOkList) {
...
func easyjsonFed925a0EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetOpportunitiesGroupsGroupIdOkList) {
...
func (v GetOpportunitiesGroupsGroupIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFed925a0EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetOpportunitiesGroupsGroupIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFed925a0DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetOpportunitiesGroupsGroupIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFed925a0DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonFed925a0DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetOpportunitiesGroupsGroupIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFed925a0EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetOpportunitiesGroupsGroupIdOk) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetOpportunitiesGroupsGroupIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFed925a0EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetOpportunitiesGroupsGroupIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFed925a0DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetOpportunitiesGroupsGroupIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFed925a0DecodeGithubComAntihaxGoesiV11(l, v)
}
