...
func easyjson191b3d72DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetOpportunitiesTasksTaskIdOkList) {
...
func easyjson191b3d72EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetOpportunitiesTasksTaskIdOkList) {
...
func (v GetOpportunitiesTasksTaskIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson191b3d72EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetOpportunitiesTasksTaskIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson191b3d72DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetOpportunitiesTasksTaskIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson191b3d72DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson191b3d72DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetOpportunitiesTasksTaskIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson191b3d72EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetOpportunitiesTasksTaskIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
...
func (v GetOpportunitiesTasksTaskIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson191b3d72EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetOpportunitiesTasksTaskIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson191b3d72DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetOpportunitiesTasksTaskIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson191b3d72DecodeGithubComAntihaxGoesiV11(l, v)
}
