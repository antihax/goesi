...
func easyjson95a81519DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetSovereigntyStructures200OkList) {
...
func easyjson95a81519EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetSovereigntyStructures200OkList) {
...
func (v GetSovereigntyStructures200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson95a81519EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetSovereigntyStructures200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson95a81519DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyStructures200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson95a81519DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson95a81519DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetSovereigntyStructures200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson95a81519EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetSovereigntyStructures200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetSovereigntyStructures200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson95a81519EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetSovereigntyStructures200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson95a81519DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetSovereigntyStructures200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson95a81519DecodeGithubComAntihaxGoesiV11(l, v)
}
