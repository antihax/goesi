...
func easyjson720e5c79DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetUniverseCategoriesCategoryIdNotFoundList) {
...
func easyjson720e5c79EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetUniverseCategoriesCategoryIdNotFoundList) {
...
func (v GetUniverseCategoriesCategoryIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson720e5c79EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetUniverseCategoriesCategoryIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson720e5c79DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseCategoriesCategoryIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson720e5c79DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson720e5c79DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetUniverseCategoriesCategoryIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson720e5c79EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetUniverseCategoriesCategoryIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetUniverseCategoriesCategoryIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson720e5c79EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseCategoriesCategoryIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson720e5c79DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseCategoriesCategoryIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson720e5c79DecodeGithubComAntihaxGoesiV11(l, v)
}
