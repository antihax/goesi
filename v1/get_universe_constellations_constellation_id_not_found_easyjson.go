...
func easyjson1cc3e21cDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetUniverseConstellationsConstellationIdNotFoundList) {
...
func easyjson1cc3e21cEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetUniverseConstellationsConstellationIdNotFoundList) {
...
func (v GetUniverseConstellationsConstellationIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1cc3e21cEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetUniverseConstellationsConstellationIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson1cc3e21cDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseConstellationsConstellationIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1cc3e21cDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson1cc3e21cDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetUniverseConstellationsConstellationIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1cc3e21cEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetUniverseConstellationsConstellationIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetUniverseConstellationsConstellationIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1cc3e21cEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseConstellationsConstellationIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1cc3e21cDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseConstellationsConstellationIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1cc3e21cDecodeGithubComAntihaxGoesiV11(l, v)
}
