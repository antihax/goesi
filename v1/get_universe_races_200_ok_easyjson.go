...
func easyjson7da6d1c1DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetUniverseRaces200OkList) {
...
func easyjson7da6d1c1EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetUniverseRaces200OkList) {
...
func (v GetUniverseRaces200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7da6d1c1EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetUniverseRaces200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson7da6d1c1DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseRaces200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7da6d1c1DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson7da6d1c1DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetUniverseRaces200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7da6d1c1EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetUniverseRaces200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetUniverseRaces200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7da6d1c1EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseRaces200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7da6d1c1DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseRaces200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7da6d1c1DecodeGithubComAntihaxGoesiV11(l, v)
}
