...
func easyjson87807fe2DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetUniverseSchematicsSchematicIdOkList) {
...
func easyjson87807fe2EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetUniverseSchematicsSchematicIdOkList) {
...
func (v GetUniverseSchematicsSchematicIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson87807fe2EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetUniverseSchematicsSchematicIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson87807fe2DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSchematicsSchematicIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson87807fe2DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson87807fe2DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetUniverseSchematicsSchematicIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson87807fe2EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetUniverseSchematicsSchematicIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.CycleTime != 0 {
...
func (v GetUniverseSchematicsSchematicIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson87807fe2EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseSchematicsSchematicIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson87807fe2DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSchematicsSchematicIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson87807fe2DecodeGithubComAntihaxGoesiV11(l, v)
}
