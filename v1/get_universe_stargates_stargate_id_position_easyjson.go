...
func easyjson4d044e33DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetUniverseStargatesStargateIdPositionList) {
	...
	if in.IsNull() {
		...
		*out = nil
		...
		if *out == nil {
			if !in.IsDelim(']') {
				*out = make(GetUniverseStargatesStargateIdPositionList, 0, 5)
			} else {
...
func easyjson4d044e33EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetUniverseStargatesStargateIdPositionList) {
...
func (v GetUniverseStargatesStargateIdPositionList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4d044e33EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetUniverseStargatesStargateIdPositionList) UnmarshalJSON(data []byte) error {
	...
	easyjson4d044e33DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStargatesStargateIdPositionList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4d044e33DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson4d044e33DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetUniverseStargatesStargateIdPosition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4d044e33EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetUniverseStargatesStargateIdPosition) {
	out.RawByte('{')
	first := true
	_ = first
	if in.X != 0 {
...
func (v GetUniverseStargatesStargateIdPosition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4d044e33EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStargatesStargateIdPosition) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4d044e33DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStargatesStargateIdPosition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4d044e33DecodeGithubComAntihaxGoesiV11(l, v)
}
