...
func easyjson651b74e0DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *GetUniverseStructuresStructureIdNotFoundList) {
...
func easyjson651b74e0EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in GetUniverseStructuresStructureIdNotFoundList) {
...
func (v GetUniverseStructuresStructureIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson651b74e0EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *GetUniverseStructuresStructureIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson651b74e0DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStructuresStructureIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson651b74e0DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson651b74e0DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *GetUniverseStructuresStructureIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson651b74e0EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in GetUniverseStructuresStructureIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v GetUniverseStructuresStructureIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson651b74e0EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseStructuresStructureIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson651b74e0DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseStructuresStructureIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson651b74e0DecodeGithubComAntihaxGoesiV11(l, v)
}
