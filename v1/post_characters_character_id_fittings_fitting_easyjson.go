...
func easyjson746f8c8DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsFittingList) {
...
func easyjson746f8c8EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PostCharactersCharacterIdFittingsFittingList) {
...
func (v PostCharactersCharacterIdFittingsFittingList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson746f8c8EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PostCharactersCharacterIdFittingsFittingList) UnmarshalJSON(data []byte) error {
	...
	easyjson746f8c8DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdFittingsFittingList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson746f8c8DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson746f8c8DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsFitting) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "items":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson746f8c8DecodeGithubComAntihaxGoesiV12(in, &v4)
...
func easyjson746f8c8EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PostCharactersCharacterIdFittingsFitting) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
	...
	if len(in.Items) != 0 {
		...
		if in.Items == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.Items {
				...
				easyjson746f8c8EncodeGithubComAntihaxGoesiV12(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func (v PostCharactersCharacterIdFittingsFitting) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson746f8c8EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdFittingsFitting) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson746f8c8DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdFittingsFitting) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson746f8c8DecodeGithubComAntihaxGoesiV11(l, v)
}
func easyjson746f8c8DecodeGithubComAntihaxGoesiV12(in *jlexer.Lexer, out *PostCharactersCharacterIdFittingsItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson746f8c8EncodeGithubComAntihaxGoesiV12(out *jwriter.Writer, in PostCharactersCharacterIdFittingsItem) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Flag != 0 {
