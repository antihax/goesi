...
func easyjsonEdf473b9DecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PostFleetsFleetIdWingsCreatedList) {
...
func easyjsonEdf473b9EncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PostFleetsFleetIdWingsCreatedList) {
...
func (v PostFleetsFleetIdWingsCreatedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEdf473b9EncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PostFleetsFleetIdWingsCreatedList) UnmarshalJSON(data []byte) error {
	...
	easyjsonEdf473b9DecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdWingsCreatedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEdf473b9DecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonEdf473b9DecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PostFleetsFleetIdWingsCreated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEdf473b9EncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PostFleetsFleetIdWingsCreated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.WingId != 0 {
...
func (v PostFleetsFleetIdWingsCreated) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEdf473b9EncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostFleetsFleetIdWingsCreated) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonEdf473b9DecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdWingsCreated) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEdf473b9DecodeGithubComAntihaxGoesiV11(l, v)
}
