...
func easyjson8e08947bDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PostFleetsFleetIdWingsWingIdSquadsCreatedList) {
...
func easyjson8e08947bEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PostFleetsFleetIdWingsWingIdSquadsCreatedList) {
...
func (v PostFleetsFleetIdWingsWingIdSquadsCreatedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8e08947bEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PostFleetsFleetIdWingsWingIdSquadsCreatedList) UnmarshalJSON(data []byte) error {
	...
	easyjson8e08947bDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdWingsWingIdSquadsCreatedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8e08947bDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson8e08947bDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PostFleetsFleetIdWingsWingIdSquadsCreated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8e08947bEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PostFleetsFleetIdWingsWingIdSquadsCreated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.SquadId != 0 {
...
func (v PostFleetsFleetIdWingsWingIdSquadsCreated) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8e08947bEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostFleetsFleetIdWingsWingIdSquadsCreated) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8e08947bDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFleetsFleetIdWingsWingIdSquadsCreated) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8e08947bDecodeGithubComAntihaxGoesiV11(l, v)
}
