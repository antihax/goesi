...
func easyjson7f10966bDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PostUiOpenwindowNewmailUnprocessableEntityList) {
...
func easyjson7f10966bEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PostUiOpenwindowNewmailUnprocessableEntityList) {
...
func (v PostUiOpenwindowNewmailUnprocessableEntityList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7f10966bEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PostUiOpenwindowNewmailUnprocessableEntityList) UnmarshalJSON(data []byte) error {
	...
	easyjson7f10966bDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostUiOpenwindowNewmailUnprocessableEntityList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7f10966bDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson7f10966bDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PostUiOpenwindowNewmailUnprocessableEntity) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7f10966bEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PostUiOpenwindowNewmailUnprocessableEntity) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v PostUiOpenwindowNewmailUnprocessableEntity) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7f10966bEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostUiOpenwindowNewmailUnprocessableEntity) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7f10966bDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostUiOpenwindowNewmailUnprocessableEntity) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7f10966bDecodeGithubComAntihaxGoesiV11(l, v)
}
