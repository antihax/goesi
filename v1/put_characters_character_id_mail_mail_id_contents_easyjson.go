...
func easyjsonA501c44dDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PutCharactersCharacterIdMailMailIdContentsList) {
...
func easyjsonA501c44dEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PutCharactersCharacterIdMailMailIdContentsList) {
...
func (v PutCharactersCharacterIdMailMailIdContentsList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA501c44dEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PutCharactersCharacterIdMailMailIdContentsList) UnmarshalJSON(data []byte) error {
	...
	easyjsonA501c44dDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutCharactersCharacterIdMailMailIdContentsList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA501c44dDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjsonA501c44dDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PutCharactersCharacterIdMailMailIdContents) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA501c44dEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PutCharactersCharacterIdMailMailIdContents) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Labels) != 0 {
...
func (v PutCharactersCharacterIdMailMailIdContents) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA501c44dEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutCharactersCharacterIdMailMailIdContents) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonA501c44dDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutCharactersCharacterIdMailMailIdContents) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA501c44dDecodeGithubComAntihaxGoesiV11(l, v)
}
