...
func easyjson9f4cf6dDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdMovementList) {
...
func easyjson9f4cf6dEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdMovementList) {
...
func (v PutFleetsFleetIdMembersMemberIdMovementList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9f4cf6dEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PutFleetsFleetIdMembersMemberIdMovementList) UnmarshalJSON(data []byte) error {
	...
	easyjson9f4cf6dDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdMovementList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9f4cf6dDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson9f4cf6dDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PutFleetsFleetIdMembersMemberIdMovement) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9f4cf6dEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PutFleetsFleetIdMembersMemberIdMovement) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Role != "" {
...
func (v PutFleetsFleetIdMembersMemberIdMovement) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9f4cf6dEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutFleetsFleetIdMembersMemberIdMovement) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson9f4cf6dDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdMembersMemberIdMovement) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9f4cf6dDecodeGithubComAntihaxGoesiV11(l, v)
}
