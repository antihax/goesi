...
func easyjson7e20b68eDecodeGithubComAntihaxGoesiV1(in *jlexer.Lexer, out *PutFleetsFleetIdSquadsSquadIdNotFoundList) {
...
func easyjson7e20b68eEncodeGithubComAntihaxGoesiV1(out *jwriter.Writer, in PutFleetsFleetIdSquadsSquadIdNotFoundList) {
...
func (v PutFleetsFleetIdSquadsSquadIdNotFoundList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7e20b68eEncodeGithubComAntihaxGoesiV1(&w, v)
...
func (v *PutFleetsFleetIdSquadsSquadIdNotFoundList) UnmarshalJSON(data []byte) error {
	...
	easyjson7e20b68eDecodeGithubComAntihaxGoesiV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdSquadsSquadIdNotFoundList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7e20b68eDecodeGithubComAntihaxGoesiV1(l, v)
}
func easyjson7e20b68eDecodeGithubComAntihaxGoesiV11(in *jlexer.Lexer, out *PutFleetsFleetIdSquadsSquadIdNotFound) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7e20b68eEncodeGithubComAntihaxGoesiV11(out *jwriter.Writer, in PutFleetsFleetIdSquadsSquadIdNotFound) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Error_ != "" {
...
func (v PutFleetsFleetIdSquadsSquadIdNotFound) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7e20b68eEncodeGithubComAntihaxGoesiV11(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PutFleetsFleetIdSquadsSquadIdNotFound) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7e20b68eDecodeGithubComAntihaxGoesiV11(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PutFleetsFleetIdSquadsSquadIdNotFound) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7e20b68eDecodeGithubComAntihaxGoesiV11(l, v)
}
