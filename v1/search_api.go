...
@return []int64*/
func (a *SearchApiService) GetCharactersCharacterIdSearch(ctx context.Context, categories []string, search string, characterId int32, localVarOptionals map[string]interface{}) ([]int64, *http.Response, error) {
	var (
