 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return []int64*/
func (a SearchApiService) GetCharactersCharacterIdSearch(ctx context.Context, characterId int32, search string, categories []string, localVarOptionals map[string]interface{}) ([]int64,  *http.Response, error) {
	var (
