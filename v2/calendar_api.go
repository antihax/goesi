...
@param optional (nil or map[string]interface{}) with one or more of:
    ...
    @param "xUserAgent" (string) Client identifier, takes precedence over User-Agent
@return */
func (a *CalendarApiService) PutCharactersCharacterIdCalendarEventId(ctx context.Context, eventId int32, response string, characterId int32, localVarOptionals map[string]interface{}) (*http.Response, error) {
	var (
