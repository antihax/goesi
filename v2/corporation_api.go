...
func (a *CorporationApiService) GetCorporationsNames(corporationIds []int32, localVarOptionals map[string]interface{}) ([]GetCorporationsNames200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
