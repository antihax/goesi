...
func easyjson1a3daa96DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetAlliancesNames200OkList) {
...
func easyjson1a3daa96EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetAlliancesNames200OkList) {
...
func (v GetAlliancesNames200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1a3daa96EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetAlliancesNames200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson1a3daa96DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesNames200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1a3daa96DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjson1a3daa96DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetAlliancesNames200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1a3daa96EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetAlliancesNames200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetAlliancesNames200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1a3daa96EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetAlliancesNames200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1a3daa96DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetAlliancesNames200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1a3daa96DecodeGithubComAntihaxGoesiV21(l, v)
}
