...
func easyjson6213c735DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesJumpCloneList) {
...
func easyjson6213c735EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetCharactersCharacterIdClonesJumpCloneList) {
...
func (v GetCharactersCharacterIdClonesJumpCloneList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6213c735EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetCharactersCharacterIdClonesJumpCloneList) UnmarshalJSON(data []byte) error {
	...
	easyjson6213c735DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdClonesJumpCloneList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6213c735DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjson6213c735DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetCharactersCharacterIdClonesJumpClone) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6213c735EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetCharactersCharacterIdClonesJumpClone) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCharactersCharacterIdClonesJumpClone) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6213c735EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdClonesJumpClone) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson6213c735DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdClonesJumpClone) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6213c735DecodeGithubComAntihaxGoesiV21(l, v)
}
