...
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdOkList) {
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdOkList) {
...
func (v GetCharactersCharacterIdPlanetsPlanetIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2db8f1a3EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "pins":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson2db8f1a3DecodeGithubComAntihaxGoesiV22(in, &v5)
		...
		case "routes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson2db8f1a3DecodeGithubComAntihaxGoesiV23(in, &v6)
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Links) != 0 {
	...
	if len(in.Pins) != 0 {
		...
		if in.Pins == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v9, v10 := range in.Pins {
				...
				easyjson2db8f1a3EncodeGithubComAntihaxGoesiV22(out, v10)
			}
			out.RawByte(']')
		}
	}
	if len(in.Routes) != 0 {
		...
		if in.Routes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v11, v12 := range in.Routes {
				...
				easyjson2db8f1a3EncodeGithubComAntihaxGoesiV23(out, v12)
			}
			out.RawByte(']')
		}
	}
...
func (v GetCharactersCharacterIdPlanetsPlanetIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson2db8f1a3EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdPlanetsPlanetIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPlanetsPlanetIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson2db8f1a3DecodeGithubComAntihaxGoesiV21(l, v)
}
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV23(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "waypoints":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson2db8f1a3DecodeGithubComAntihaxGoesiV24(in, &v13)
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV23(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdRoute) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.Waypoints) != 0 {
		...
		if in.Waypoints == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v14, v15 := range in.Waypoints {
				...
				easyjson2db8f1a3EncodeGithubComAntihaxGoesiV24(out, v15)
			}
			out.RawByte(']')
		}
	}
...
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV24(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdWaypoint) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV24(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdWaypoint) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Order != 0 {
...
func easyjson2db8f1a3DecodeGithubComAntihaxGoesiV22(in *jlexer.Lexer, out *GetCharactersCharacterIdPlanetsPlanetIdPin) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson2db8f1a3EncodeGithubComAntihaxGoesiV22(out *jwriter.Writer, in GetCharactersCharacterIdPlanetsPlanetIdPin) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
