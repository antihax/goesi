...
func easyjsonFa80e40cDecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetCharactersCharacterIdPortraitOkList) {
...
func easyjsonFa80e40cEncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetCharactersCharacterIdPortraitOkList) {
...
func (v GetCharactersCharacterIdPortraitOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFa80e40cEncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetCharactersCharacterIdPortraitOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonFa80e40cDecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPortraitOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFa80e40cDecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjsonFa80e40cDecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetCharactersCharacterIdPortraitOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonFa80e40cEncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetCharactersCharacterIdPortraitOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Px128x128 != "" {
...
func (v GetCharactersCharacterIdPortraitOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFa80e40cEncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdPortraitOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonFa80e40cDecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdPortraitOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFa80e40cDecodeGithubComAntihaxGoesiV21(l, v)
}
