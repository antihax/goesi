...
func easyjson1b4a1ef7DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetCorporationsNames200OkList) {
...
func easyjson1b4a1ef7EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetCorporationsNames200OkList) {
...
func (v GetCorporationsNames200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1b4a1ef7EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetCorporationsNames200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson1b4a1ef7DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsNames200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1b4a1ef7DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjson1b4a1ef7DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetCorporationsNames200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1b4a1ef7EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetCorporationsNames200Ok) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCorporationsNames200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1b4a1ef7EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsNames200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson1b4a1ef7DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsNames200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1b4a1ef7DecodeGithubComAntihaxGoesiV21(l, v)
}
