...
func easyjson41562567DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetDogmaEffectsEffectIdOkList) {
...
func easyjson41562567EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetDogmaEffectsEffectIdOkList) {
...
func (v GetDogmaEffectsEffectIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson41562567EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetDogmaEffectsEffectIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson41562567DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaEffectsEffectIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson41562567DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjson41562567DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetDogmaEffectsEffectIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson41562567EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetDogmaEffectsEffectIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
...
func (v GetDogmaEffectsEffectIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson41562567EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetDogmaEffectsEffectIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson41562567DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetDogmaEffectsEffectIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson41562567DecodeGithubComAntihaxGoesiV21(l, v)
}
