...
func easyjson8d6c8028DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *GetUniverseSystemKills200OkList) {
...
func easyjson8d6c8028EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in GetUniverseSystemKills200OkList) {
...
func (v GetUniverseSystemKills200OkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8d6c8028EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *GetUniverseSystemKills200OkList) UnmarshalJSON(data []byte) error {
	...
	easyjson8d6c8028DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemKills200OkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8d6c8028DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjson8d6c8028DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *GetUniverseSystemKills200Ok) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8d6c8028EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in GetUniverseSystemKills200Ok) {
	out.RawByte('{')
	first := true
	_ = first
	if in.NpcKills != 0 {
...
func (v GetUniverseSystemKills200Ok) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8d6c8028EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseSystemKills200Ok) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8d6c8028DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemKills200Ok) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8d6c8028DecodeGithubComAntihaxGoesiV21(l, v)
}
