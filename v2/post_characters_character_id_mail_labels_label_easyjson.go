...
func easyjsonE446b04DecodeGithubComAntihaxGoesiV2(in *jlexer.Lexer, out *PostCharactersCharacterIdMailLabelsLabelList) {
...
func easyjsonE446b04EncodeGithubComAntihaxGoesiV2(out *jwriter.Writer, in PostCharactersCharacterIdMailLabelsLabelList) {
...
func (v PostCharactersCharacterIdMailLabelsLabelList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE446b04EncodeGithubComAntihaxGoesiV2(&w, v)
...
func (v *PostCharactersCharacterIdMailLabelsLabelList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE446b04DecodeGithubComAntihaxGoesiV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdMailLabelsLabelList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE446b04DecodeGithubComAntihaxGoesiV2(l, v)
}
func easyjsonE446b04DecodeGithubComAntihaxGoesiV21(in *jlexer.Lexer, out *PostCharactersCharacterIdMailLabelsLabel) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE446b04EncodeGithubComAntihaxGoesiV21(out *jwriter.Writer, in PostCharactersCharacterIdMailLabelsLabel) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Color != "" {
...
func (v PostCharactersCharacterIdMailLabelsLabel) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE446b04EncodeGithubComAntihaxGoesiV21(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdMailLabelsLabel) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE446b04DecodeGithubComAntihaxGoesiV21(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdMailLabelsLabel) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE446b04DecodeGithubComAntihaxGoesiV21(l, v)
}
