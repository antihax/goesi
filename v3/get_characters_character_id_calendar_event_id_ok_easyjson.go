...
func easyjson78a31a36DecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *GetCharactersCharacterIdCalendarEventIdOkList) {
...
func easyjson78a31a36EncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in GetCharactersCharacterIdCalendarEventIdOkList) {
...
func (v GetCharactersCharacterIdCalendarEventIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson78a31a36EncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *GetCharactersCharacterIdCalendarEventIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson78a31a36DecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdCalendarEventIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson78a31a36DecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjson78a31a36DecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *GetCharactersCharacterIdCalendarEventIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson78a31a36EncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in GetCharactersCharacterIdCalendarEventIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v GetCharactersCharacterIdCalendarEventIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson78a31a36EncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdCalendarEventIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson78a31a36DecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdCalendarEventIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson78a31a36DecodeGithubComAntihaxGoesiV31(l, v)
}
