...
func easyjson4fc9c45eDecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *GetCharactersCharacterIdOkList) {
...
func easyjson4fc9c45eEncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in GetCharactersCharacterIdOkList) {
...
func (v GetCharactersCharacterIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4fc9c45eEncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *GetCharactersCharacterIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjson4fc9c45eDecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4fc9c45eDecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjson4fc9c45eDecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *GetCharactersCharacterIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4fc9c45eEncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in GetCharactersCharacterIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AncestryId != 0 {
...
func (v GetCharactersCharacterIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4fc9c45eEncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4fc9c45eDecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4fc9c45eDecodeGithubComAntihaxGoesiV31(l, v)
}
