...
func easyjson3cad633cDecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillsSkillList) {
...
func easyjson3cad633cEncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in GetCharactersCharacterIdSkillsSkillList) {
...
func (v GetCharactersCharacterIdSkillsSkillList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3cad633cEncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *GetCharactersCharacterIdSkillsSkillList) UnmarshalJSON(data []byte) error {
	...
	easyjson3cad633cDecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdSkillsSkillList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3cad633cDecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjson3cad633cDecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *GetCharactersCharacterIdSkillsSkill) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3cad633cEncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in GetCharactersCharacterIdSkillsSkill) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v GetCharactersCharacterIdSkillsSkill) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3cad633cEncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCharactersCharacterIdSkillsSkill) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson3cad633cDecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCharactersCharacterIdSkillsSkill) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3cad633cDecodeGithubComAntihaxGoesiV31(l, v)
}
