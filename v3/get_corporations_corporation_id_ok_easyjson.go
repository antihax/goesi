...
func easyjsonDab14328DecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *GetCorporationsCorporationIdOkList) {
...
func easyjsonDab14328EncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in GetCorporationsCorporationIdOkList) {
...
func (v GetCorporationsCorporationIdOkList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDab14328EncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *GetCorporationsCorporationIdOkList) UnmarshalJSON(data []byte) error {
	...
	easyjsonDab14328DecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOkList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDab14328DecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjsonDab14328DecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *GetCorporationsCorporationIdOk) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDab14328EncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in GetCorporationsCorporationIdOk) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AllianceId != 0 {
...
func (v GetCorporationsCorporationIdOk) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDab14328EncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetCorporationsCorporationIdOk) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonDab14328DecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetCorporationsCorporationIdOk) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDab14328DecodeGithubComAntihaxGoesiV31(l, v)
}
