...
func easyjsonCb1e1ff4DecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdPlanetList) {
...
func easyjsonCb1e1ff4EncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in GetUniverseSystemsSystemIdPlanetList) {
...
func (v GetUniverseSystemsSystemIdPlanetList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCb1e1ff4EncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *GetUniverseSystemsSystemIdPlanetList) UnmarshalJSON(data []byte) error {
	...
	easyjsonCb1e1ff4DecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemsSystemIdPlanetList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCb1e1ff4DecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjsonCb1e1ff4DecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *GetUniverseSystemsSystemIdPlanet) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCb1e1ff4EncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in GetUniverseSystemsSystemIdPlanet) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Moons) != 0 {
...
func (v GetUniverseSystemsSystemIdPlanet) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCb1e1ff4EncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseSystemsSystemIdPlanet) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCb1e1ff4DecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseSystemsSystemIdPlanet) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCb1e1ff4DecodeGithubComAntihaxGoesiV31(l, v)
}
