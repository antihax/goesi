...
func easyjsonE423d8f1DecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *GetUniverseTypesTypeIdDogmaAttributeList) {
...
func easyjsonE423d8f1EncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in GetUniverseTypesTypeIdDogmaAttributeList) {
...
func (v GetUniverseTypesTypeIdDogmaAttributeList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE423d8f1EncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *GetUniverseTypesTypeIdDogmaAttributeList) UnmarshalJSON(data []byte) error {
	...
	easyjsonE423d8f1DecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseTypesTypeIdDogmaAttributeList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE423d8f1DecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjsonE423d8f1DecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *GetUniverseTypesTypeIdDogmaAttribute) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE423d8f1EncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in GetUniverseTypesTypeIdDogmaAttribute) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AttributeId != 0 {
...
func (v GetUniverseTypesTypeIdDogmaAttribute) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE423d8f1EncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *GetUniverseTypesTypeIdDogmaAttribute) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonE423d8f1DecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *GetUniverseTypesTypeIdDogmaAttribute) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE423d8f1DecodeGithubComAntihaxGoesiV31(l, v)
}
