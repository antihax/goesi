...
func easyjson891887feDecodeGithubComAntihaxGoesiV3(in *jlexer.Lexer, out *PostCharactersCharacterIdCspaCreatedList) {
...
func easyjson891887feEncodeGithubComAntihaxGoesiV3(out *jwriter.Writer, in PostCharactersCharacterIdCspaCreatedList) {
...
func (v PostCharactersCharacterIdCspaCreatedList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson891887feEncodeGithubComAntihaxGoesiV3(&w, v)
...
func (v *PostCharactersCharacterIdCspaCreatedList) UnmarshalJSON(data []byte) error {
	...
	easyjson891887feDecodeGithubComAntihaxGoesiV3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdCspaCreatedList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson891887feDecodeGithubComAntihaxGoesiV3(l, v)
}
func easyjson891887feDecodeGithubComAntihaxGoesiV31(in *jlexer.Lexer, out *PostCharactersCharacterIdCspaCreated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson891887feEncodeGithubComAntihaxGoesiV31(out *jwriter.Writer, in PostCharactersCharacterIdCspaCreated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Cost != 0 {
...
func (v PostCharactersCharacterIdCspaCreated) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson891887feEncodeGithubComAntihaxGoesiV31(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *PostCharactersCharacterIdCspaCreated) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson891887feDecodeGithubComAntihaxGoesiV31(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostCharactersCharacterIdCspaCreated) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson891887feDecodeGithubComAntihaxGoesiV31(l, v)
}
